...
const searchEngines = new bl.SearchEngineList([new bl.MediaMarktPriceSearchEngine(), new bl.AmazonPriceSearchEngine2(), new bl.EbayPriceSearchEngine(), new bl.SaturnPriceSearchEngine()]);
